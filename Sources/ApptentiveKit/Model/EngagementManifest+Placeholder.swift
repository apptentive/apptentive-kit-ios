...
extension EngagementManifest {
    static let placeholder: Self = {
        ...
        let configuration = TextModalConfiguration(title: AttributedString(fallbackTitle), name: nil, body: AttributedString(fallbackMessage), actions: [.init(id: "dismiss", label: fallbackButtonTitle, actionType: .dismiss, invocations: [])])
