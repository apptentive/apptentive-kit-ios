...
public class DialogView: UIView {
    ...
    @objc public dynamic var titleTextColor: UIColor = .apptentiveDialogTitle

    /// The foreground color of the message text in TextModal ("Note") interactions.
    @objc public dynamic var messageTextColor: UIColor = .apptentiveDialogMessage

    /// The font used for the title text.
    @objc public dynamic var titleFont: UIFont = .apptentiveDialogTitle

    /// The font used for the message text in TextModal ("Note") interactions.
    @objc public dynamic var messageFont: UIFont = .apptentiveDialogMessage
    ...
    @objc public dynamic var separatorColor: UIColor = .apptentiveDialogSeparator
    ...
    private func configure() {
        self.backgroundColor = .apptentiveDialogBackground
        ...
        self.headerImageView.accessibilityIdentifier = "DialogHeaderImageView"
        self.headerImageView.isAccessibilityElement = true
