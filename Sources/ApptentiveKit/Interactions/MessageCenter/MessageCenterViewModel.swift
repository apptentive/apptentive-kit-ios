...
public class MessageCenterViewModel: MessageManagerDelegate {
    ...
    init(configuration: MessageCenterConfiguration, interaction: Interaction, interactionDelegate: MessageCenterInteractionDelegate) {
        ...
        self.composerAttachButtonTitle = NSLocalizedString("MC Attach Button Accessibility Label", bundle: .apptentive, value: "Attach", comment: "The accessibility label for the attach button.")
        ...
        self.sendButtonAccessibilityLabel = NSLocalizedString("MC Send Button Accessibility Label", bundle: .apptentive, value: "Send", comment: "The accessibility label for the send button.")
        self.sendButtonAccessibilityHint = NSLocalizedString("MC Send Button Accessibility Hint", bundle: .apptentive, value: "Sends the message.", comment: "The accessibility hint for the send button.")
        self.attachButtonAccessibilityLabel = NSLocalizedString("MC Attach Button Accessibility Label", bundle: .apptentive, value: "Attach", comment: "The accessibility label for the attach button.")
        self.attachButtonAccessibilityHint = NSLocalizedString("MC Attach Button Accessibility Hint", bundle: .apptentive, value: "Attaches a photo or file.", comment: "The accessibility hint for the attach button.")
        self.closeButtonAccessibilityLabel = NSLocalizedString("MC Close Button Accessibility Label", bundle: .apptentive, value: "Close", comment: "The accessibility label for the close button.")
        self.closeButtonAccessibilityHint = NSLocalizedString("MC Close Button Accessibility Hint", bundle: .apptentive, value: "Closes Message Center.", comment: "The accessibility hint for the close button.")
        self.profileButtonAccessibilityLabel = NSLocalizedString("MC Profile Button Accessibility Label", bundle: .apptentive, value: "Profile", comment: "The accessibility label for the profile button.")
        self.profileButtonAccessibilityHint = NSLocalizedString("MC Profile Button Accessibility Hint", bundle: .apptentive, value: "Displays the name and email editor.", comment: "The accessibility hint for the profile button.")
        self.showAttachmentButtonAccessibilityHint = NSLocalizedString("Show Attachment Accessibility Hint", bundle: .apptentive, value: "Double-tap to open.", comment: "The accessibility hint for viewing attachments.")
        self.downloadAttachmentButtonAccessibilityHint = NSLocalizedString("Download Attachment Accessibility Hint", bundle: .apptentive, value: "Double-tap to download.", comment: "The accessibility hint for downloading attachments.")
        self.attachmentOptionsTitle = NSLocalizedString("Attachment Options Title", bundle: .apptentive, value: "Select an attachment type.", comment: "The title for the attachment options alert.")
        self.attachmentOptionsFilesButton = NSLocalizedString("Attachment Options Files Button", bundle: .apptentive, value: "Files", comment: "The button label for the images attachment option.")
