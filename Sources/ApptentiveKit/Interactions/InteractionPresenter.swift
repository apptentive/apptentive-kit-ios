...
@MainActor open class InteractionPresenter {
    ...
    open func presentEnjoymentDialog(with viewModel: DialogViewModel) async throws {
        ...
        if #available(iOS 26, *) {
            viewController = GlassDialogViewController(viewModel: viewModel)
        } else {
            viewController = EnjoymentDialogViewController(viewModel: viewModel)
        }
    ...
    open func presentTextModal(with viewModel: DialogViewModel) async throws {
        ...
        if #available(iOS 26, *) {
            ...
            viewController = TextModalViewController(viewModel: viewModel)
        }
    ...
    open func presentViewController(_ viewControllerToPresent: UIViewController) async throws {
        ...
        var isDialog = viewControllerToPresent is DialogViewController

        if #available(iOS 26, *) {
            isDialog = viewControllerToPresent is GlassDialogViewController
        }
