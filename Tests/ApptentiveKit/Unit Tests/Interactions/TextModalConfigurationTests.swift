...
struct TextModalConfigurationTests {
    @Test func testDecoding() throws {
        let json = """
                 {
                    ...
                    "image": {
                        "url": "https://github.com/apptentive/test-logos/blob/main/full-width.png?raw=true",
                        "layout": "fill",
                        "alt_text": "Alchemer Logo"
                    },
                    "max_height": 40
                }
            """
        ...
        #expect(configuration.image?.url == URL(string: "https://github.com/apptentive/test-logos/blob/main/full-width.png?raw=true")!)
        #expect(configuration.image?.layout == "fill")
        #expect(configuration.image?.altText == "Alchemer Logo")
    }
