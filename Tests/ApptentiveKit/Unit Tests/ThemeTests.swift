...
final class ThemeTests {
    ...
    @MainActor func withCustomerTheme() throws {
        ...
        guard let errorColor = UIColor(named: "Apptentive/Error", in: bundle, compatibleWith: nil),
            ...
            let dialogSeparatorColor = UIColor(named: "Apptentive/Dialog/LegacySeparator", in: bundle, compatibleWith: nil),
        ...
        #expect(UIColor.apptentiveSecondaryGroupedBackground == secondaryGroupedBackgroundColor)
        #expect(UIColor.apptentiveDialogBackground == dialogBackgroundColor)
        #expect(UIColor.apptentiveDialogTitle == dialogTitleTextColor)
        #expect(UIColor.apptentiveDialogMessage == dialogMessageTextColor)
        #expect(UIColor.apptentiveDialogSeparator == dialogSeparatorColor)
        ...
        #expect(UIImage.apptentiveMessageAttachmentButton == messageAttachmentButtonImage)
        #expect(UIImage.apptentiveDialogHeader == dialogHeaderImage)
    }
    ...
    @MainActor func withNoTheme() {
        ...
        if #available(iOS 26, *) {
            #expect(UIColor.apptentiveMessageCenterTextInputBorder == .clear)
        } else {
        ...
        if #available(iOS 26, *) {
            #expect(UIColor.apptentiveTextInputBorder == .clear)
            #expect(UIColor.apptentiveSurveyTextInputBackground == .clear)
        } else {
            #expect(UIColor.apptentiveTextInputBorder == .lightGray)
            #expect(UIColor.apptentiveSurveyTextInputBackground == .apptentiveTextInputBackground)
        }
        ...
        if #available(iOS 26, *) {
            #expect(UIColor.apptentiveTextInputBorderSelected == .clear)
