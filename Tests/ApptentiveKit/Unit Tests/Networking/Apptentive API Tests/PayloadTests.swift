...
struct PayloadTests {
    ...
    @Test func testUpdateCredentialsInPlaintextSinglePart() throws {
        ...
        let payloadContext = Payload.Context(tag: ".", credentials: .embedded(id: "abc"), sessionID: "abc123", encoder: jsonEncoder, authenticationContext: nil)
        ...
        try payload.updateCredentials(.header(id: "abc", token: "456"), using: jsonEncoder, decoder: jsonDecoder, authenticationContext: nil)
    ...
    @Test func testUpdateCredentialsInEncryptedSinglePart() throws {
        ...
        let payloadContext = Payload.Context(tag: ".", credentials: .header(id: "abc", token: "123"), sessionID: "abc123", encoder: jsonEncoder, authenticationContext: nil)

        var payload = try Payload(wrapping: MessageList.Message(nonce: messageNonce, body: "testing"), with: payloadContext, attachmentURLProvider: MockAttachmentURLProviding())

        try payload.updateCredentials(.embedded(id: "abc"), using: jsonEncoder, decoder: jsonDecoder, authenticationContext: .init(encryptionKey: encryptionKey, token: "456"))
    ...
    @Test func testConvertToEncryptedSinglePart() throws {
        ...
        try payload.updateCredentials(.header(id: "abc", token: "456"), using: jsonEncoder, decoder: jsonDecoder, authenticationContext: .init(encryptionKey: encryptionKey, token: "456"))
