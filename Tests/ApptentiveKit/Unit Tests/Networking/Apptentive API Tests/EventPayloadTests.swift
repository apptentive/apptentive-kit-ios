...
class EventPayloadTests: XCTestCase {
    ...
    func testEncoding() throws {
        ...
        try checkPayloadEquivalence(between: self.testPayload.jsonObject, and: expectedEncodedContent, comparisons: ["label"])
    }
    ...
    func testInteractionEventEncoding() throws {
        ...
        try checkPayloadEquivalence(between: interactionPayload.jsonObject, and: expectedEncodedContent, comparisons: ["label", "interaction_id"])
    }
    ...
    func testEventUserInfoEncoding() throws {
        ...
        try checkPayloadEquivalence(between: interactionPayload.jsonObject, and: expectedEncodedContent, comparisons: ["label", "interaction_id", "data"])
    }
    ...
    func testCustomDataEventEncoding() throws {
        ...
        try checkPayloadEquivalence(between: eventPayload.jsonObject, and: expectedEncodedContent, comparisons: ["label", "custom_data"])
    }
}
